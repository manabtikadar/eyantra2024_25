...
class RobotArmController(Node):
    ...
    def move_arm_to_positions(self):
        ...
        # Intermediate1 = [0.50, -0.10, 0.40]
        # Intermediate2 = [0.60, 0.20, 0.20]
        # Intermediate3 = [0.50, -0.20, 0.20]

        # Move to P1, Attach the box, then move to D
        #self.move_arm(Intermediate1)
        self.move_arm(P1)
        self.attach_box('obj_1')
        #self.move_arm(Intermediate1)
        #self.move_arm(Intermediate2)
        self.move_arm(D)
    ...
    def move_arm(self, position):
        ...
        quat_xyzw = [0.0, 0.707, 0.0, 0.707] #[0.0, 0.0, 0.0, 1.0]  # Default orientation

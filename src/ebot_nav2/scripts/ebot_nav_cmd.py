...
def main():
    ...
    initial_pose.pose.position.x = 1.8377093152421504
    initial_pose.pose.position.y = -9.05036472031192
    ...
    goal_pose1.pose.orientation.z = 0.00
    ...
    goal_pose2.pose.orientation.z = 0.00
    ...
    goal_pose3.pose.orientation.z = 0.00
    ...
    while not navigator.isTaskComplete():
        ...
        if feedback and i % 5 == 0:
            ...
            #     goal_pose4.pose.orientation.z = 0.00
